...
export default () => (
    <Container2>
      <Profile
        ...
        video={"https://www.youtube.com/embed/Ppq027vmciQ?autoplay=1&mute=1&controls=0&&showinfo=0&loop=1"}
      />
    </Container2>
);